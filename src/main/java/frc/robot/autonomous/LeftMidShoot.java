...
/** Add your docs here. */
public class LeftMidShoot extends AutonomousRoutine{
     public LeftMidShoot(FMJRobotContainer robot, double velocity, double acceleration,
        ...
        try {
            firstPath = PathPlannerPath.fromPathFile("Left Mid Shoot");
            secondPath = PathPlannerPath.fromPathFile("Left Mid Shoot Second");
